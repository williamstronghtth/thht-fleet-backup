...
# Full verification. The previous version disabled hostname checking and set
# CERT_NONE, which silently accepts any certificate — meaning the "research" this
# briefing ingests could be substituted wholesale by a man-in-the-middle.
# Verified 2026-08-30 that default verification works fine from this host.
