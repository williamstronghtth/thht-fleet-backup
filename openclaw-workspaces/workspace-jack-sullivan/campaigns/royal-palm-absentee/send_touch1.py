#!/usr/bin/env python3
"""Royal Palm Absentee - Touch 1 Email follow-up to Chris's cold calls"""
...
SUBJECT = "Following up on Chris's call about your Royal Palm property"
TEMPLATE = """Hi {first_name},

My team lead Chris gave you a call today about your property in Royal Palm. He wanted to connect since you own there but live out of the area.
...
# Skip William Walsh — warm lead, Chris handling directly
SKIP_EMAILS = {
    "gerriartassoc@aol.com"   # William Walsh - interested, warm lead
}
...
def main():
    ...
    for l in leads:
        ...
        eligible.append(l)
    log('='*50)
    log('Royal Palm Absentee - Touch 1')
    log('='*50)
    log(f'Total leads: {len(leads)}')
    log(f'Eligible (with email, deduplicated, skips removed): {len(eligible)}')
    log(f'Skipped: William Walsh (warm lead)')
    sent = errors = 0
