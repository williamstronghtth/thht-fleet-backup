#!/usr/bin/env python3
"""Sanctuary Absentee - Touch 1 Email follow-up to Chris's cold calls"""
...
SUBJECT = "Following up on Chris's call about your Sanctuary property"
TEMPLATE = """Hi {first_name},

My team lead Chris gave you a call today about your property in The Sanctuary. He wanted to connect since you own there but live out of the area.
...
def main():
    ...
    for l in leads:
        ...
        eligible.append(l)
    log('='*50)
    log('The Sanctuary Absentee - Touch 1')
    log('='*50)
    log(f'Total leads: {len(leads)}')
    log(f'Eligible (with email, deduplicated): {len(eligible)}')
    sent = errors = 0
